...
public class BinaryTreeClass implements Cloneable{
    ...
    public Object clone(){
     ...
     public void cloneToPostOrder(BinaryTreeClass a){
        clone();
        a.postorder();
     }
     
     public void cloneToPreOrder(BinaryTreeClass a){
        clone();
        a.preorder();
     }
//    
//     public void evaluated(BinaryTreeNode r){
//         InfixToPostfix i = new InfixToPostfix();
//         i.postfix(r.left.element.toString());
//         i.postfix(r.right.element.toString());
//     }
 }
